...
class MealDetails extends StatelessWidget {
  ...
  const MealDetails(this.toglefavorite, this.isfavorite, {Key? key})
      : super(key: key);
  final Function toglefavorite, isfavorite;
  ...
  // ontapoffab(BuildContext context) {
